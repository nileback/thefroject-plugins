# The Froject Sales Plugin

Sales workspace toolkit: outreach, deal strategy, competitor intel, pipeline management, and battlecards.
...
- **Ad Copy Writer** — Write paid ad copy for Google, Meta, and LinkedIn campaigns
- **Case Study Writer** — Transform customer stories into compelling case studies
- **Sales Outreach Writer** — Write personalized sales emails, sequences, and follow-ups
- **Sales Intel Researcher** — Research target accounts and prospects for sales outreach
- **Win-Loss Analyzer** — Analyze won and lost deals to identify patterns and improve win rates
- **Proposal Writer** — Write business proposals, RFP responses, and partnership pitches
- **Proposal Voice Guide** — Copywriting voice, structure, and non-negotiables for client-facing documents
- **Pricing Guidelines** — Pricing tiers, engagement models, and pricing copy rules for proposals
- **RevOps Analyst** — Optimize lead lifecycle, pipeline management, and revenue operations
...
- **Email Sequence Builder** — Design email sequences with copywriting frameworks, behavioral triggers, and lifecycle architecture
...
- **Cold Email Writer** — Write B2B cold outreach emails that get replies
- **Marketing Psychology** — Apply behavioral psychology principles to marketing decisions
...
- **Objection Handler** — Build objection handling frameworks with tested responses
- **Sales Battlecard Builder** — Create competitor battle cards for sales conversations
- **Deal Strategy Analyzer** — Analyze deal structure, advancement strategy, and risk factors
...
- **Connections Optimizer** — Analyze professional networks for outreach opportunities and warm paths
...
- **/pipeline-prospect** — Lead intelligence pipeline: signals, enrichment, warm paths, outreach, tracking
- **/pipeline-qbr** — QBR cycle pipeline: health scoring, QBR deck, renewal strategy, stakeholder update
- **/pipeline-battlecard** — Competitive intelligence pipeline: research, baseline diff, battlecard, review, distribute
