# The Froject People Culture Plugin

People & culture toolkit: job descriptions, interview design, performance reviews, DEI audits, and onboarding.
...
- **Job Description Writer** — Write clear, inclusive job descriptions that attract the right candidates
- **Interview Designer** — Design structured interview processes with scorecards and questions
...
- **Performance Review Writer** — Draft fair, specific performance reviews and feedback
...
- **DEI Audit Guide** — Assess DEI maturity with metrics, gap analysis, and initiative planning
- **Training Program Designer** — Design learning paths, training programs, and upskilling plans
- **Employee Survey Analyst** — Analyze engagement survey results with trend detection and action planning
