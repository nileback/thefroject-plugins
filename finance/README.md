# The Froject Finance Plugin

Finance workspace toolkit: budgeting, forecasting, financial reporting, billing ops, and audit preparation.
...
- **Compensation Benchmarker** — Research and analyze compensation data for roles and markets
...
- **Ad Spend Allocator** — Optimize multi-channel ad budget allocation based on performance data
...
- **Financial Report Writer** — Write clear financial summaries for leadership and board audiences
