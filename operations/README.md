# The Froject Operations Plugin

Operations workspace toolkit: process optimization, compliance, vendor management, SOPs, and project management.
...
- **Policy Writer** — Draft company policies, handbooks, and compliance documents
- **SOP Writer** — Create standard operating procedures for repeatable processes
- **Event Planner** — Plan events, conferences, and workshops with timelines and logistics
- **Proposal Writer** — Write business proposals, RFP responses, and partnership pitches
- **Process Optimizer** — Analyze and improve business processes for efficiency
- **Change Management Guide** — Plan and communicate organizational changes and transitions
...
- **Compliance Checker** — Audit processes and documentation for regulatory compliance
...
- **Budget Analyzer** — Analyze budget vs actuals, flag variances, and identify spending trends
- **Expense Categorizer** — Classify expenses, flag anomalies, and identify cost optimization opportunities
- **Audit Prep Guide** — Prepare for financial and compliance audits with checklists and gap analysis
- **Escalation Framework** — Document, route, and manage customer escalations systematically
- **Vendor Management Guide** — Evaluate vendors, review contracts, and track relationships
- **Risk Register Builder** — Identify, assess, and track operational risks with mitigation plans
- **Process Mapping Tool** — Document business processes with workflow mapping and improvement analysis
- **Training Program Designer** — Design learning paths, training programs, and upskilling plans
